[![Coverage](https://sonarcloud.io/api/project_badges/measure?project=sudo-lucifer_automated-clean-code&metric=coverage)](https://sonarcloud.io/summary/new_code?id=sudo-lucifer_automated-clean-code)
